...
<html lang="en">
    <head>
        ...
        <title>Create Archivos_documento</title>
    </head>
    <body>
        <div class = 'container'>
            <h1>Create Archivos_documento</h1>
            <form method = 'get' action = 'http://alb.app:8000/archivos_documento'>
                <button class = 'btn blue'>Archivos_documento Index</button>
            </form>
            <br>
            <form method = 'POST' action = 'http://alb.app:8000/archivos_documento'>
                ...
                <div class="input-field col s6">
                    <input id="documentos_id" name = "documentos_id" type="text" class="validate">
